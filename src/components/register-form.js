            ...
            <Container fluid className={"register-form align-items-center p-0 py-5 d-flex minh-100vh "+this.props.classExt}>
                <Row className="mx-auto text-start w-100 pt-5">
                    <Col xs={11} md={6} lg={5} className="mx-auto p-0 d-flex align-items-center">
                        <Form className="text-start w-100 border border-light-brw p-4 rounded bg-form shadow text-light-brw opacity-9 fw-bold z-index-10"
                            autoComplete="off"
                            method="POST">
                            <div className="border-bottom border-light-brw mb-4">
                            ...
                            <Form.Group controlId="formFirst">
                                <Form.Label>First Name</Form.Label>
                                 <Form.Control type="text" 
                                    ...
                                    className="rounded-pill border-light-brw text-light-brw"
                                    maxLength="50"
                                    name="userName"
                            ...
                            <div className="w-100 text-start py-3">
                                <p className="text-light-brw fw-normal">
                                    Registered? 
                                    <Link to={this.props.backLink.href} className="text-light-brw fw-bold text-decoration-none">
                            ...
                            <div className="w-100 text-end py-1">
                                <Button 
                                    ...
                                    type="reset" 
                                    className="mx-1 rounded-pill border-light-brw text-light-brw">
                                    Clear
                                </Button>
