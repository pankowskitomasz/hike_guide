...
class ContactData extends Component{
    render(){
        ...
        return(        
            <Container fluid className={"bg-contact-short align-items-center p-0 d-flex minh-25vh "+this.props.classExt}>
                <Row className="mx-auto text-center w-100 py-5 mt-5">                    
